...
function ViewStoryRoute (){
    ...
    return (
        <div className="ViewStory">
            <h2>{title}</h2>
            <p className="storyPara"> This is a <span className="insert">{adj}</span> story about <span className="insert">{adj2}</span> things.</p>
            <p className="storyPara">It's not very <span className="insert">{adj3}</span>, but I bet it'll make you feel <span className="insert">{feeling}</span>.</p>
